...
async function main() {
  ...
  const r = await fetch(`${BASE}/events?limit=3&offset=0`);
  ...
  fs.writeFileSync('data/insert_kill_events_small.sql', sql);
  console.log('WROTE data/insert_kill_events_small.sql');
}
